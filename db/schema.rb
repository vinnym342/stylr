...
ActiveRecord::Schema.define(version: 20170513163846) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.datetime "asker_view_time"
    t.datetime "stylist_view_time"
  ...
  create_table "hashtags", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["styleboard_id"], name: "index_hashtags_on_styleboard_id"
  end
